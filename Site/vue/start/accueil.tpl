		...
		<div id="carousel-example-generic" class="carousel slide col-md-offset-1 col-md-10" data-ride="carousel"> <!--- carousel --->
			...
			<div class="carousel-inner">
				<div class="item active">
					<a href="#">
						<img alt="First slide" src="vue/images/foule_noir_blanc.png">
					</a>
				</div>
				<div class="item">
					<a href="#">
						<img alt="Second slide" src="vue/images/foule2_noir_blanc.png">
					</a>
				</div>
				<div class="item">
					<a href="#">
						<img alt="Third slide" src="vue/images/foule3_noir_blanc.png">
					</a>
				</div>
			</div>
